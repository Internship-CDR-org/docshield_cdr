...
public class DOCXThreatAnalyzerTest {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            ...
            System.err.println(
                    "Usage: java threat.docx.DOCXThreatAnalyzerTest <file.docx>"
            );
        ...
        try {
            ...
            System.out.println();
            System.out.println(
                    "DOCX THREAT ANALYZER TEST PASSED"
            );
            ...
            System.err.println();
            System.err.println(
                    "DOCX THREAT ANALYZER TEST FAILED"
            );
